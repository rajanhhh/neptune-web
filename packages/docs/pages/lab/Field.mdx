...
import { Checkbox, Alert } from '@transferwise/components';
import code from '../../liveEditorCode/field.code';

Field is a new component that provides validation to its children. Validation messages are automatically attached to the validated component with styling.
Currently the supported children types are:
